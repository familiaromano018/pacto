    ...
    (
      ...
      >
        <svg width="48" height="48" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M 50 12 A 38 38 0 0 0 50 88" stroke="url(#s)" strokeWidth="11" strokeLinecap="round" fill="none" />
          <path d="M 50 12 A 38 38 0 0 1 50 88" stroke="url(#g)" strokeWidth="11" strokeLinecap="round" fill="none" />
